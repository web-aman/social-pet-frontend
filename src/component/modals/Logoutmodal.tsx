      ...
      <div className="p-4 sm:p-10 bg-gray-50 rounded-md  w-[300px] md:w-[500px] text-center overflow-y-auto">
        ...
        <div className="mt-6 flex justify-center gap-x-4">
          <button
            disabled={isPending}
            onClick={() => logoutUser()}
            className="py-2.5 px-4 inline-flex justify-center items-center gap-2 rounded-md border font-medium bg-white text-gray-700 shadow-sm align-middle hover:bg-[#FF553E] hover:text-white transition-all text-sm"
          >
            Logout
          </button>
          <button
            ...
            type="button"
            className="py-2.5 px-4 inline-flex justify-center items-center gap-2 rounded-md border border-transparent font-semibold bg-[#FF553E] text-white hover:bg-[#FF553E] focus:outline-none focus:ring-2  transition-all text-sm"
          >
            Cancel
          </button>
        </div>
